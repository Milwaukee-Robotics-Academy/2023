...
public class DriveSegment extends SwerveControllerCommand{
    ...
    public DriveSegment(SwerveBase swerve,
        ...
        public void initialize() {
            ...
            if (m_resetPostion)
            {
                m_swerveBase.zeroHeading();
                m_swerveBase.resetOdometry(m_initialPose);
            }   
        }
        private static TrajectoryConfig getDefaultTrajectoryConfig(SwerveBase swerve, boolean stopAtEnd) {
        ...
        private static ProfiledPIDController getThetaController() {
            var profileConstraints = AutoConstants.kThetaControllerConstraints;
        ...
        protected static final Pose2d WAYPOINT_START2 = new Pose2d(1.37, 2.75, Rotation2d.fromDegrees(0));
        protected static final Pose2d WAYPOINT_START3 = new Pose2d(1.37, 4.42, Rotation2d.fromDegrees(0));
        protected static final Pose2d WAYPOINT_GP1 = new Pose2d(7.05, .91, Rotation2d.fromDegrees(-45));
        ...
        protected static final Pose2d WAYPOINT_CHARGESTATION = new Pose2d(3.82, 2.73, Rotation2d.fromDegrees(0));
