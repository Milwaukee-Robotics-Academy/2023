...
public static final class Arm{
    ...
    public static final class Swerve {
        ...
        public static final double trackWidth = 0.4; // Units.inchesToMeters(21.73); //TODO: This must be tuned to
                                                     // specific robot
        public static final double wheelBase = 0.394; // Units.inchesToMeters(21.73); //TODO: This must be tuned to
                                                      // specific robot
